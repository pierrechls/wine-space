...
<style>
	...
	@media only screen and (max-width: 480px) { 
		...
		table tr td:nth-of-type(2):before { content: "Quantité"; }
		table tr td:nth-of-type(3):before { content: "Total"; }
		table tr td:nth-of-type(4):before { content: ""; }
		table tr td:nth-of-type(5):before { content: ""; }
		
		table tr td.product-total:nth-of-type(1):before { content: ""; }
		table tr td.product-total:nth-of-type(2):before { content: ""; }
		table tr td.product-total:nth-of-type(1){ padding-left: 0; text-align: center;}
		table tr td.product-total:nth-of-type(2){ padding-left: 0; text-align: center;}
